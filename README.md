...
│   └── export_osnet.py         # Script xuất mô hình TransReID-SSL ViT-S/16 sang ONNX cho Triton
...
5. **MobileCLIP (Ultralytics fork)**
   - Mô hình mã hóa văn bản và hình ảnh Open-Vocabulary cho tính năng YOLOE text prompt encoding (`mobileclip_blt.ts`).
   - [GitHub Repository (Ultralytics fork)](https://github.com/ultralytics/mobileclip)
